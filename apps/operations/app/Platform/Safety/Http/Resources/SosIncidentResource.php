...
final class SosIncidentResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'note' => $this->worker_note,
            'delivery_state' => match ($this->status->value) {
            ...
            'device_activated_at' => $this->device_activated_at->toIso8601String(),
            ...
            'asset' => $this->when($this->relationLoaded('operationalAsset') && $this->operationalAsset !== null, fn (): array => [
                ...
                'label' => $this->operationalAsset->name,
            ]),
