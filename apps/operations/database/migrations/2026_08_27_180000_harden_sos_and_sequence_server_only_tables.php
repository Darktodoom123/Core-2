...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($missing !== []) {
            throw new RuntimeException(
                'Cannot harden SOS and Sequence server-only tables; missing tables: '.implode(', ', $missing),
            );
        }
    ...
    public function down(): void
    {
        ...
        // Data API privileges intentionally remain revoked on rollback.
    }
    ...
    private function sequences(): array
    {
        ...
        foreach (self::SEQUENCE_TABLES as $table) {
            ...
            if ($sequence === null) {
                throw new RuntimeException(
                    'Cannot harden SOS server-only tables; missing sequence for '.$table.'.',
                );
            }
