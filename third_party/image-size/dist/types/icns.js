...
exports.ICNS = {
    ...
    calculate(input) {
        ...
        while (imageOffset < fileLength && imageOffset < inputLength) {
            ...
            const nextImageOffset = imageOffset + imageHeader[1];
            if (nextImageOffset <= imageOffset || nextImageOffset > fileLength || nextImageOffset > inputLength) {
                throw new TypeError('Invalid ICNS entry bounds');
            }
