    ...
    it('renders attachment list, counter, and action buttons', async () => {
        ...
        const view = await render(
            <PhotoAttachmentPicker
                attachments={[
                    {
                        uri: 'file:///existing_1.jpg',
                        fileName: 'existing_1.jpg',
                    },
                ]}
                maxCount={4}
        ...
        expect(
            view.getByTestId('photo-attachment-picker-take-photo'),
        ).toBeTruthy();
        expect(
            view.getByTestId('photo-attachment-picker-choose-gallery'),
        ).toBeTruthy();
