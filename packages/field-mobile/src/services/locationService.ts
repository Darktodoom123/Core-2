import type { DispatchJob, LocationSharePayload, User } from '../types/index.js';
import type { CommandOutboxManager } from './commandOutbox.js';
...
export class LocationSharingService {
  ...
  public canShareLocation(user?: User | null, job?: DispatchJob | null): boolean {
