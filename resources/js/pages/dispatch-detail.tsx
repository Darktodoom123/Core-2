...
export default function DispatchDetail({
    ...
    return (
        <>
            <Head title={`${job.reference} assignment workspace`} />
                                ...
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                                    <div>
                                        ...
                                        <p className="mt-1 max-w-3xl text-sm leading-6 text-ink-soft">
                                            Availability, credential validity,
                                            asset readiness, maintenance, and
                                            overlapping schedules are computed
                                            by the server for this dispatch
                                            window.
                                        </p>
                                    </div>
