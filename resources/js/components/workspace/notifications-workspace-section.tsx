                        ...
                        <div className="relative mt-3 w-full sm:w-80">
                            ...
                            {searchQuery !== '' && (
                                <button
                                    ...
                                    className="absolute top-1/2 right-2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded text-ink-soft hover:bg-surface-subtle hover:text-ink"
                                >
                                ...
                                {filteredNotifications.map((n) => {
                                    ...
                                    return (
                                        <li
                                            key={n.id}
                                            className={cn(
                                                'group flex flex-wrap items-start justify-between gap-4 p-4 transition-colors',
                                                unread
                                                    ? 'bg-brand-soft/25'
