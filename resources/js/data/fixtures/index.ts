...
export const fuelRequests: FuelRequest[] = [
    {
        ...
        reference: 'FR-0891',
        assetCode: 'CR-110-03',
        equipmentName: 'Demag AC 100 All Terrain Crane',
        equipmentType: 'Mobile Crane',
        registrationNumber: 'CRN-5501-PH',
    ...
    },
    {
        ...
        reference: 'FR-0890',
        assetCode: 'TR-03',
        equipmentName: 'Isuzu 10-Wheeler Dump Truck',
        equipmentType: 'Dump Truck',
        registrationNumber: 'TRK-9821-PH',
    ...
    },
    {
        ...
        reference: 'FR-0884',
        assetCode: 'CR-220-01',
        equipmentName: 'Liebherr LTM 1220 Heavy Crane',
        equipmentType: 'Mobile Crane',
        registrationNumber: 'CRN-8002-PH',
        jobReference: 'CON-1248',
