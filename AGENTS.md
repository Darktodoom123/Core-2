...
6. AI Quality Gate: For major features, complex refactors, or sprint implementations (and for small tweaks ONLY when explicitly requested), evaluate and document responses to the 4 mandatory AI verification questions in [`.ai-reports/ai-verification-questions.md`](file:///c:/Users/User/Desktop/Core-2/.ai-reports/ai-verification-questions.md):
