...
flowchart TD
    ...
    OFFICE["👨‍💼 Office Staff / Operations Planner"]
    ...
    CORE1["Core 1: Sales, CRM, Client, Job Order, Rental, Project"]
...
flowchart TB
    %% External Entities
    E_CORE1["External Core 1"]
    E_OFFICE["Office Operations Planner"]
    E_APPROVER["Manager / Approver"]
    E_FIELD["Field Driver / Operator"]

    %% Data Stores
    D1[("D1: Upstream References & Service Requests")]
    ...
    P1(("1.0 Service Dispatch Scheduling"))
    ...
    P1 -->|"Write Source Reference & Operational Request"| D1
...
flowchart TD
    ...
    %% Processes
    P1_1(("1.1 Received Service & Job Scheduling"))
    ...
    %% Step 1: Draft Intake
    OPS_USER -->|"1. Review Handoff / Transitional Local Input"| P1_1
...
| --- | --- | --- |
| **External Entity** | `[Rectangle]` | Users (Client, Operations Planner, Driver, Approver) or External Systems (S3 Storage, GPT AI Service) |
