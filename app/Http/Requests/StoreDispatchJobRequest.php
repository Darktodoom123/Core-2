...
final class StoreDispatchJobRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'client' => ['required', 'string', 'max:255'], 'title' => ['required', 'string', 'max:255'],
            'site' => ['required', 'string', 'max:2000'], 'site_notes' => ['nullable', 'string', 'max:5000'],
            'scheduled_start' => ['required', 'date'], 'scheduled_end' => ['required', 'date', 'after:scheduled_start'],
            'priority' => ['required', Rule::enum(DispatchPriority::class)], 'requirements' => ['sometimes', 'array'],
